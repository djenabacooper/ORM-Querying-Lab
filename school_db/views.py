...
def problem_three(request):
  ...
  for course in courses:
    print(f'{course.instructor.first_name} {course.instructor.last_name} {course.name}')
...
def problem_five(request):
    new_student = Student.objects.create(first_name="Djenaba",last_name="Cooper",year=2022, gpa=4.0)
    print(new_student.id, new_student.first_name,  new_student.last_name, new_student.gpa)
    return complete(request)
...
def problem_six(request):
    updated_student = Student.objects.filter(pk=11).update(gpa=3.5)
    students = Student.objects.get(pk=11)
    print(students.pk, students.first_name, students.last_name, students.gpa)
    return complete(request)
